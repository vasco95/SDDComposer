...
/**
 * @author vasco
 * This class implements template feature of sddc
 */
...
public class GraphTemplate {
	...
	protected VmInfo[] vms = new VmInfo[0];
	protected RouterInfo[] routers = new RouterInfo[0];
	protected SubnetInfo[] subnets = new SubnetInfo[0];
